...
\begin{equation}\begin{aligned}\label{intermediate}
	\sum_{\bm r_1,\bm r_2} \braket{\psi_\text{gs}({\bm r_2}) | c_{{\bm k}\sigma}(t) c^\dagger_{{\bm k}\sigma} | \psi_\text{gs}({\bm r_1})} = N\sum_{\bm r, n} F_n(\bm k) \braket{\psi_\text{gs}({\bm r_d}) | c_{{\bm k}\sigma}(t) \ket{\psi_{n}({\bm r_d})}\bra{\psi_{n}({\bm r_d})} c^\dagger_{{\bm k}\sigma} | \psi_\text{gs}({\bm r_d})}~,
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}\label{tmatrix}
	\mathcal{T}_{{\bm k}\sigma} = c_{{\bm k}\sigma}\left[\left(\sum_{\sigma^\prime}c^\dagger_{\bm r_d\sigma} + \text{h.c.}\right) + \left(S_{\bm r_d}^+ + \text{h.c.}\right) + \left(C_{\bm r_d}^+ + \text{h.c.}\right)\right]~,
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	\braket{\psi_\text{gs}({\bm r_d}) | \mathcal{T}_{{\bm k}\sigma}(t) | \psi_{n}({\bm r_d})} = \braket{\psi_\text{gs}({\bm r_d}) | e^{i(H_\text{clust}(\bm r_d) + H_\text{cav}(\bm r_d))t} \mathcal{T}_{{\bm k}\sigma}(t) e^{-i(H_\text{clust}(\bm r_d) + H_\text{cav}(\bm r_d))t} | \psi_{n}({\bm r_d})}~,
\end{aligned}\end{equation}
where \(H_\text{cav}(\bm r_d)\) is the ``cavity" Hamiltonian formed by removing the cluster Hamiltonian \(H_\text{clust}(\bm r_d)\) from the total Hamiltonian \(H_\text{latt}\): \(H_\text{latt} = H_\text{clust}(\bm r_d) + H_\text{cav}(\bm r_d)\).
