...
\begin{equation}\begin{aligned}\label{tmatrix}
	\mathcal{T}_{{\bm k},\sigma} = c_{\bm r_d\sigma} + \left[c^\dagger_{\bm r_d\sigma} + S_{\bm r_d}^\sigma + C_{\bm r_d}^+ \right]c_{{\bm k}\sigma}~,
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
\sum_{\bm r_d}\braket{\Psi_\text{gs} | c_{{\bm r_d + \bm r},\sigma}(t) c^\dagger_{{\bm r_d},\sigma} | \Psi_\text{gs}} = F_n^*(\bm r)\sum_{\bm r_d}\braket{\Psi_\text{gs} | c_{{\bm r_d},\sigma}(t) c^\dagger_{{\bm r_d},\sigma} | \Psi_\text{gs}}.
\end{aligned}\end{equation}
