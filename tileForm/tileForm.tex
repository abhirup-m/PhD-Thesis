...
In order to create the bulk model, we need to translate the local auxiliary model over the entire lattice. For this, we define {\it many-particle global} translation operators \(T({\bm a})\) that translate all positions by a vector \({\bm a}\). In terms of many-body states and operators, their action is defined as 
