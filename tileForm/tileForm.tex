...
\begin{equation}\begin{aligned}
	G(\bm k,\sigma;\omega) =  \sum_n &\left[\frac{\braket{\psi_\text{gs}({\bm r_d}) | \mathcal{T}_{{\bm k}\sigma} | \psi_{n}({\bm r_d})}\braket{\psi_n({\bm r_d}) | \mathcal{T}_{{\bm k}\sigma}^\dagger | \psi_\text{gs}({\bm r_d})}}{\omega - (E_n - E_0 + \epsilon_{\bm k})}\right.\\
...
\begin{equation}\begin{aligned}
	G(\bm k,\sigma;\omega) = \theta(t)\mathcal{G}^>(\mathcal{T}_{\bm k,\sigma}; \omega - \epsilon_{\bm k}) - \mathcal{G}^<(\mathcal{T}_{\bm k,\sigma}; \omega + \epsilon_{\bm k})~.
\end{aligned}\end{equation}
