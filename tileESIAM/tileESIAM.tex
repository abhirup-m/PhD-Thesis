...
\end{aligned}\end{equation}
where \(\delta\) is a primitive lattice vector. [CHECK THE ALGEBRA.] This operator creates an exciton: a bound holon-doublon pair between the sites \(i\) and \(i + \delta\). In terms of these operators, the Hamiltonian becomes
\begin{equation}\begin{aligned}
