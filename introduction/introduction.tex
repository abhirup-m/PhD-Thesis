...
\section{Auxiliary model approaches towards studying the Mott MIT}

\subsection{Why do we need another auxiliary model method?}

\section{Brief introduction to the tiling auxiliary model approach}
\subsection{Overview}
\subsection{Features}

\section{Entanglement, RG, and Emergent Geometry}
\subsection{Introduction to AdS-CFT}
\subsection{Open questions}

\section{Ab-Initio Demonstration of the holographic principle}
