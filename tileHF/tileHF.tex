...
\begin{equation}\begin{aligned}
	\frac{\Delta K_\alpha}{\Delta D} = -\int_{UV} d{\bf q} ~\rho({\bf q}) \left[K_\alpha({\bf k}_1, {\bf q})K_\alpha({\bf q}, {\bf k}_2) + 4K_\alpha({\bf q}, \bar {\bf q})W_{\bar\alpha}({\bf k}_1, {\bf q}, \bar {\bf q}, {\bf k}_2)\right]\left(\frac{1}{4}\frac{1}{1/ G_\alpha^K({\bf q}) + 3J/4}\right.\\
																																																										   \left. + \frac{3}{4}\frac{1}{1/ G_\alpha^K({\bf q}) - J/4}\right)~.
\end{aligned}\end{equation}
where the indirect Greens function \( G^K_\alpha\) is defined as
\begin{equation}\begin{aligned}
	 G_\alpha^K({\bf q}) = \frac{1}{\omega - |\epsilon_{\bar\alpha}({\bf q})| / 2 + K_\alpha({\bf q}) / 4 + W_{\bar\alpha}({\bf q}) / 2}~,
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	G^{JK} = \frac{1}{\omega - |\epsilon_\alpha({\bf q})| / 2 + J_\alpha/4 + K_{\bar\alpha}/4 - J_\perp / 4}~,
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	\sum_\alpha \left[P_\text{dir}(\alpha)H_\text{ind}(\bar\alpha) + H_\text{ind}(\bar\alpha)P_\text{dir}(\alpha)\right] + \text{h.c.} = \frac{1}{2}{\bf S}_d \cdot {\bf S}_{f} \sum_{\alpha,q,k} \frac{J_\alpha(q, k)K_{\bar\alpha}(k, q)}{1/G^{JK} - J_\perp / 4} ~.
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}\label{interRenormalisation}
	\frac{\Delta J_\perp}{\Delta D} = \int_{UV} d{\bf q} ~\rho({\bf q})~\int_{IR} d{\bf k} \rho({\bf k}) \sum_{\alpha,q,k} \frac{J_\alpha(q, k)K_{\bar\alpha}(k, q)}{1/G^{JK} - J_\perp / 4}~.
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	\frac{\Delta J_\perp}{\Delta D} =& -\frac{1}{4}\int_\text{UV} d{q} \rho(q) \int_\text{UV + IR} d{k} \rho(k) \sum_\alpha \left[J_\alpha^2(q,k)\left(\frac{1}{1/G_\alpha^J + 3J_\perp/4} + \frac{1}{1/G_\alpha^J - J_\perp/4}\right)\right.\\
									 &\left. K_\alpha^2(q,k)\left(\frac{1}{1/G_\alpha^K + 3J_\perp/4} + \frac{1}{1/G_\alpha^K - J_\perp/4}\right)\right]\\
									 &+ \int_\text{UV} d{q} \rho(q) \int_\text{UV + IR} d{k} \rho(k)\sum_\alpha \frac{J_\alpha(q,k)K_{\bar\alpha}(k, q)}{1/G^{JK}_\alpha - J_\perp/4}\\
									 &+ \frac{1}{2} \int_{UV} d{\bf q} ~\rho({\bf q}) \left[J_f(\bar{\bf q},{\bf q}) J_d({\bf q},\bar{\bf q})\sum_\alpha \frac{1}{1/G^J_{\alpha\alpha}({\bf q}) - J_\perp/4} \right.\\
									&~~~\left.+ K_f(\bar{\bf q},{\bf q}) K_d({\bf q},\bar{\bf q})\sum_\alpha \frac{1}{1/G^K_{\alpha\alpha}({\bf q}) - J_\perp/4}\right]
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	...
	&+ \frac{1}{2}\int_{UV} d{\bf q} ~\rho({\bf q}) \left[K_{\bar\alpha}({\bf k}_1, {\bf q})K_{\bar\alpha}({\bf q}, {\bf k}_2) - 4K_{\bar\alpha}({\bf q}, \bar {\bf q})W_{\alpha}({\bf k}_1, {\bf q},  {\bf q}, {\bf k}_2)\right]\\
...
\begin{equation}\begin{aligned}
	...
	&\left(\frac{1}{4}\frac{1}{1/ G_\alpha^K({\bf q}) + 3J/4} + \frac{3}{4}\frac{1}{1/ G_\alpha^K({\bf q}) - J/4}\right)\\
...
\begin{equation}\begin{aligned}
	...
	\text{Inter-layer spin-flip excitation:}~ G_\alpha^K({\bf q}) &= \frac{1}{\omega - |\epsilon_{\bar\alpha}({\bf q})| / 2 + K_\alpha({\bf q}) / 4 + W_{\bar\alpha}({\bf q}) / 2}~,\\
	\text{Both spins, one of the baths:}~ G^{JK}({\bf q}) &= \frac{1}{\omega - |\epsilon_\alpha({\bf q})| / 2 + J_\alpha/4 + K_{\bar\alpha}/4 - J_\perp / 4}~,\\
