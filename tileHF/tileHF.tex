...
\begin{equation}\begin{aligned}
	P_\text{dir} = \frac{1}{2}\sum_{\alpha, k, q} J_\alpha {\bf S}_\alpha \cdot {\bf \sigma}_{\sigma_1,\sigma_2} c^\dagger_{q,\sigma_1,f}c_{k,\sigma_2,f}~,\\
	P_\text{ind} = \frac{1}{2}\sum_{\alpha, k, q} K_{\bar\alpha} {\bf S}_{\bar\alpha} \cdot {\bf \sigma}_{\sigma_1,\sigma_2} c^\dagger_{q,\sigma_1, f}c_{k,\sigma_2, f}~.
\end{aligned}\end{equation}

\paragraph{Hole sector}
These involve excited states below the Fermi energy:
\begin{equation}\begin{aligned}
	H_\text{dir} = \frac{1}{2}\sum_{\alpha, k, q} J_\alpha {\bf S}_\alpha \cdot {\bf \sigma}_{\sigma_1,\sigma_2} c^\dagger_{k,\sigma_1, f}c_{q,\sigma_2, f}~,\\
	H_\text{ind} = \frac{1}{2}\sum_{\alpha, k, q} K_{\bar\alpha} {\bf S}_{\bar\alpha} \cdot {\bf \sigma}_{\sigma_1,\sigma_2} c^\dagger_{k,\sigma_1, f}c_{q,\sigma_2, f}~.
\end{aligned}\end{equation}
\paragraph{Mixed sector}
These involve simultaneous particle and hole excitations:
\begin{equation}\begin{aligned}
	M_\text{dir} = \frac{1}{2}\sum_{\alpha, q, \bar q} J_\alpha {\bf S}_\alpha \cdot {\bf \sigma}_{\sigma_1,\sigma_2} c^\dagger_{q,\sigma_1, f}c_{\bar q,\sigma_2, f}~,\\
	M_\text{ind} = \frac{1}{2}\sum_{\alpha, q, \bar q} K_{\bar\alpha} {\bf S}_{\bar\alpha} \cdot {\bf \sigma}_{\sigma_1,\sigma_2} c^\dagger_{q,\sigma_1, f}c_{\bar q,\sigma_2}~.
\end{aligned}\end{equation}
...
\end{aligned}\end{equation}
The final equation is for the renormalisation of the direct Kondo coupling arising from indirect processes. This occurs through two routes (similar to how the direct Kondo coupling renormalised the indirect coupling through two routes in the previous section). The complete equation is
\begin{equation}\begin{aligned}
