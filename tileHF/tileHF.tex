...
\begin{equation}\begin{aligned}
	G_\alpha^{(0)}({\bf q}) = \frac{1}{\omega - |\epsilon_\alpha({\bf q})| / 2 + J_\alpha({\bf q}) / 4 + W_\alpha({\bf q}) / 2}~.
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	G_\alpha({\bf q}) = \frac{1}{1/G_\alpha^{(0)} - J \vec{S}_f\cdot\vec{S}_d}~.
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}\label{kondoRenormalisation}
	\frac{\Delta J_\alpha}{\Delta D} = -\int_{UV} d{\bf q} ~\rho({\bf q}) \left[J_\alpha({\bf k}_1, {\bf q})J_\alpha({\bf q}, {\bf k}_2) + 4J_\alpha({\bf q}, \bar {\bf q})W_\alpha({\bf k}_1, {\bf q}, \bar {\bf q}, {\bf k}_2)\right]\left(\frac{1}{4}\frac{1}{1/G_\alpha^{(0)}({\bf q}) + 3J/4}\right.\\
...
\begin{equation}\begin{aligned}\label{perpRenormalisation}
	\frac{\Delta J_\perp}{\Delta D} = -\frac{1}{4}\int_{UV} d{\bf q} ~\rho({\bf q})~\int_{IR} d{\bf k} \rho({\bf k}) \sum_\alpha J_\alpha({\bf k}, {\bf q})^2\left(\frac{1}{1/G_\alpha^{(0)} + 3J/4} + \frac{1}{1/G_\alpha^{(0)} - J/4}\right)~,
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}\label{indirectRenormalisation}
	\frac{\Delta K_\alpha}{\Delta D} = \frac{1}{2}\int_{UV} d{\bf q} ~\rho({\bf q}) J_{\bar\alpha}({\bf k}_1, {\bf q})J_{\bar\alpha}({\bf q}, {\bf k}_2) \left(\frac{1}{1/G_{\bar\alpha}^{(0)} + 3J/4} + \frac{1}{1/G_{\bar\alpha}^{(0)} - J/4}\right)~,
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}\label{indirectRenorm}
	\frac{\Delta K_\alpha}{\Delta D} = \frac{1}{2}\int_{UV} d{\bf q} ~\rho({\bf q}) \left[J_{\bar\alpha}({\bf k}_1, {\bf q})J_{\bar\alpha}({\bf q}, {\bf k}_2) - 4J_{\bar\alpha}({\bf q}, \bar {\bf q})W_{\bar\alpha}({\bf k}_1, {\bf q}, \bar {\bf q}, {\bf k}_2)\right]& \left(\frac{1}{1/G_{\bar\alpha}^{(0)} + 3J/4}\right.\\
&\left.+ \frac{1}{1/G_{\bar\alpha}^{(0)} - J/4}\right)~,
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	\frac{\Delta K_\alpha}{\Delta D} = -\int_{UV} d{\bf q} ~\rho({\bf q}) \left[K_\alpha({\bf k}_1, {\bf q})K_\alpha({\bf q}, {\bf k}_2) + 4K_\alpha({\bf q}, \bar {\bf q})W_{\bar\alpha}({\bf k}_1, {\bf q}, \bar {\bf q}, {\bf k}_2)\right]\left(\frac{1}{4}\frac{1}{1/\tilde G_\alpha^{(0)}({\bf q}) + 3J/4}\right.\\
																																																										   \left. + \frac{3}{4}\frac{1}{1/\tilde G_\alpha^{(0)}({\bf q}) - J/4}\right)~.
\end{aligned}\end{equation}
where the indirect Greens function \(\tilde G^{(0)}_\alpha\) is defined as
\begin{equation}\begin{aligned}
	\tilde G_\alpha^{(0)}({\bf q}) = \frac{1}{\omega - |\epsilon_{\bar\alpha}({\bf q})| / 2 + K_\alpha({\bf q}) / 4 + W_{\bar\alpha}({\bf q}) / 2}~,
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	\frac{\Delta J_\perp}{\Delta D} = -\frac{1}{4}\int_{UV} d{\bf q} ~\rho({\bf q})~\int_{IR} d{\bf k} \rho({\bf k}) \sum_\alpha K_\alpha({\bf k}, {\bf q})^2\left(\frac{1}{1/G_{\bar\alpha}^{(0)} + 3J/4} + \frac{1}{1/G_{\bar\alpha}^{(0)} - J/4}\right)~.
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	\frac{\Delta J_{\alpha}}{\Delta D} = \frac{1}{2}\int_{UV} d{\bf q} ~\rho({\bf q}) \left[K_{\bar\alpha}({\bf k}_1, {\bf q})K_{\bar\alpha}({\bf q}, {\bf k}_2) - 4K_{\bar\alpha}({\bf q}, \bar {\bf q})W_{\alpha}({\bf k}_1, {\bf q},  {\bf q}, {\bf k}_2)\right]& \left(\frac{1}{1/\tilde G_{\alpha}^{(0)} + 3J/4}\right.\\
&\left.+ \frac{1}{1/\tilde G_{\alpha}^{(0)} - J/4}\right)~.
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	\frac{1}{1/G^{(0)}_\alpha({\bf q}) + K_{\bar\alpha}/4 - J_\perp / 4}~,
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	\sum_\alpha \left[P_\text{dir}(\alpha)H_\text{ind}(\bar\alpha) + H_\text{ind}(\bar\alpha)P_\text{dir}(\alpha)\right] + \text{h.c.} = \frac{1}{2}{\bf S}_d \cdot {\bf S}_{f} \sum_{\alpha,q,k} \frac{J_\alpha(q, k)K_{\bar\alpha}(k, q)}{1/G^{(0)}_\alpha + K_{\bar\alpha}/4 - J_\perp / 4} ~.
\end{aligned}\end{equation}
The renormalisation of the inter-layer coupling arising from this process is
\begin{equation}\begin{aligned}
	\frac{\Delta J_\perp}{\Delta D} = \int_{UV} d{\bf q} ~\rho({\bf q})~\int_{IR} d{\bf k} \rho({\bf k}) \sum_{\alpha,q,k} \frac{J_\alpha(q, k)K_{\bar\alpha}(k, q)}{1/G^{(0)}_\alpha + K_{\bar\alpha}/4 - J_\perp / 4}~.
\end{aligned}\end{equation}
